...
$b$ approaches zero as $b$ increases. % TODO I agree with this completely, however it needs to be reworded here/justified better for the paper.
Thus the finite approximations approaches
...
statistic levels off.  % TODO Some examples/references of this would be good.
                       % Including as a possible example, using the MM1 and 
                        % showing various values of \(b\)?
...
ever reaches the boundar. Consider
...
\end{figure}
% TODO Can we add a plot of \(\max \pi_s - \epsilons\) as a function of b?
...
$R = \{\underline{\mathbf{s}}\in S \;|\; s < rb \text{ for all } s \in \underline{\mathbf{s}}\}$.
...
\end{figure}
% TODO Can we include a plot of \(\max h_... = \epsilon\) as a function of b?
...
\begin{figure}
  ...
  \end{center}
  \caption{Investigating the effect of the parameters $\epsilon$ and $r$.}
...
given parameters $\epsilon$ and $r$; and the plot on the right shows the
