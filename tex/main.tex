...
duty, and extra \textbf{C}-events would include a customer beginning
...
Equation~\ref{eqn:transitions_sojourn} above without the rows and columns
...
to be evaluated many times for each value of $x$. However, matrix methods can
