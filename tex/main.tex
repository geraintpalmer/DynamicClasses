...
they overtook more people, and were `bumped up' the queue. During
...
patient was referred to the queue in a prioritised state, this indicates that patients
have priorities that change over time.
...
% TODO I wonder if a diagram would be nice to go with this. (It's clear, but a
% diagram could be nice.)
...
In this work we use and adapt the Ciw library \cite{palmer19} to simulate
% TODO Is it adapted? Is it not just "now" a feature of ciw?
