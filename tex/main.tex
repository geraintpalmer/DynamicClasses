...
(s_{k,t} - B_{k,t}) \theta_{k,\mathcal{l}} & \text{if } \delta_{k} = -1 \text{ and } \delta_{\mathcal{l}} = 1 \text{ and } \delta_i = 0 \; \forall \; i \neq k, \mathcal{l}, \\
0 & \text{otherwise,}
\end{cases}
\end{equation}
...
(z_{k,t} - A_{k,n,t}) \theta_{k,\mathcal{l}} & \text{if } \delta_{k} = -1 \text{ and } \delta_{\mathcal{l}} = 1 \text{ and } \delta_i = 0 \; \forall \; i \neq k, \mathcal{l} \text{ and } k < K \text{ and } \mathcal{l} \neq n, K, K+1, \\
