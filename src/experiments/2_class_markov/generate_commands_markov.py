...
# TODO: Decide the values of these hyper-parameters
bound_initial = 10
bound_final = 20
bound_step = 5
...
for (
    ...
    param_string = f"{arrival_1} {arrival_2} {service_1} {service_2} {theta_12} {theta_21} {num_servers} {bound_initial} {bound_final} {bound_step} {reasonable_ratio} {epsilon}"

    hash_object = hashlib.md5(param_string.encode("utf-8"))
    pram_set_id = hash_object.hexdigest()

    command = f"python write_row_markov.py {pram_set_id} {param_string}"
